...
| **Inter-Story Repetition** | [Content Planning for Neural Story Generation with Aristotelian Rescoring](https://doi.org/10.18653/v1/2020.emnlp-main.351) | ACL | 2020 |
...
| Repetition Percentage | [Long and Diverse Text Generation with Planning-based Hierarchical Variational Model](https://doi.org/10.18653/v1/D19-1321) | ACL | 2019 |
...
|  Metric  | Paper |  Venue	| Date |
|:------|:--------:|:--------:|:--------:|
| ROUGE-WE | [Better Summarization Evaluation with Word Embeddings for ROUGE](https://doi.org/10.18653/v1/d15-1222) | ACL | 2015 |
...
| MoverScore | [MoverScore: Text Generation Evaluating with Contextualized Embeddings and Earth Mover Distance](https://doi.org/10.18653/v1/D19-1053) | ACL | 2019 |
...
| InfoLM | [InfoLM: A New Metric to Evaluate Summarization \& Data2Text Generation]() | AAAI | 2022 |
